module github.com/celestiaorg/celestia-app/tools/query-params
...
require (
	github.com/celestiaorg/celestia-app/v6 v6.0.0
	github.com/cosmos/cosmos-sdk v0.51.3
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v8 v8.2.0
	github.com/cosmos/ibc-go/v8 v8.7.2
...
require (
	...
	github.com/cometbft/cometbft v0.39.8 // indirect
