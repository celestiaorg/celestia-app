...
3. [**SDK Fibre Module**](./sdk_fibre_module.md): Specifies how the state machine handles payment, verifyig validator signatures and deducting from the escrow account.
4. [**Encoding**](./encoding.md): Specifies the encoding format of rows and the format of the shares in the original data square.
5. [**SDK Registry Module**](./sdk_registry_module.md): Stores a key value list of validator addresses to their respective Fibre DA provider addresses.
