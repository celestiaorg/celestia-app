...
If you are a consensus node operator, please follow the communication channels listed under [network upgrades](https://docs.celestia.org/how-to-guides/network-upgrade-process#network-upgrades) to learn when this release is recommended for each network (e.g. Mocha, Mainnet Beta).
