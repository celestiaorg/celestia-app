...
Currently the max square size on Mocha and Mainnet is 128. A square size of 128 has 8 MiB of capacity for blobs (see [data square table](https://gist.github.com/rootulp/bbf10f6e9cf114816aaa994eb64b63a4)).
