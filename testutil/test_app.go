...
func SetupTestAppWithGenesisValSet() *app.App {
	...
	genesisState, valSet := GenesisStateWithSingleValidator(testApp)
...
func GenesisStateWithSingleValidator(testApp *app.App) (app.GenesisState, *tmtypes.ValidatorSet) {
	privVal := mock.NewPV()
	...
	genesisState = genesisStateWithValSet(testApp, genesisState, valSet, []authtypes.GenesisAccount{acc}, balances...)
