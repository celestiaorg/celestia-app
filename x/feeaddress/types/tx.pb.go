...
// - It has no signer (unsigned transaction)
...
type MsgForwardFees struct {
	// proposer is the bech32-encoded address of the block proposer.
	// This is used for validation in ProcessProposal to ensure only the
	// actual block proposer can include this transaction.
...
func (m *MsgForwardFees) GetProposer() string {
	if m != nil {
		return m.Proposer
	}
	return ""
...
var fileDescriptor_7123d30f9b490d42 = []byte{
	...
	0x4e, 0x07, 0xa9, 0xcf, 0x2d, 0x4e, 0x87, 0x68, 0x50, 0xd2, 0xe1, 0xe2, 0xf3, 0x2d, 0x4e, 0x77,
	0xcb, 0x2f, 0x2a, 0x4f, 0x2c, 0x4a, 0x71, 0x4b, 0x4d, 0x2d, 0x16, 0x92, 0xe2, 0xe2, 0x28, 0x28,
	0xca, 0x2f, 0xc8, 0x2f, 0x4e, 0x2d, 0x92, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0xf3, 0x95,
	0x24, 0xb8, 0xc4, 0x50, 0x55, 0x07, 0xa5, 0x16, 0x17, 0xe4, 0xe7, 0x15, 0xa7, 0x1a, 0x15, 0x73,
	0x31, 0xfb, 0x16, 0xa7, 0x0b, 0xa5, 0x72, 0x71, 0x23, 0x9b, 0xa5, 0xa6, 0x87, 0xdd, 0x3d, 0x7a,
	0xa8, 0xa6, 0x48, 0xe9, 0x11, 0xa7, 0x0e, 0x66, 0x9b, 0x14, 0x6b, 0xc3, 0xf3, 0x0d, 0x5a, 0x8c,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x33, 0x3a, 0xbf, 0x28, 0x1d, 0xce, 0xd6,
	0x4d, 0x2c, 0x28, 0xd0, 0xaf, 0x40, 0x0e, 0xc5, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70,
	0xa8, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xad, 0x0e, 0x4d, 0xb7, 0x69, 0x01, 0x00, 0x00,
}
...
type MsgClient interface {
	...
	// tokens from the fee address to the fee collector as a real transaction fee.
	// This message has no signer - it is injected by the block proposer in
	// PrepareProposal and validated in ProcessProposal.
