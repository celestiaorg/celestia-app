...
// signatures over the validator set at a given block height.
// Validators sign the validator set, powers, and EVM addresses of
// the entire validator set at the height of a
// ValsetRequest and submit that signature with this message.
//
// If a sufficient number of validators (66% of voting power) (A) have set
// EVM addresses and (B) submit ValsetConfirm messages with their
// signatures it is then possible for anyone to view these signatures in the
// chain store and submit them to EVM to update the validator set
// -------------
type MsgValsetConfirm struct {
	...
	// EVM address, associated to the orchestrator, used to sign the `ValSet`
	// message.
...
func (m *MsgValsetConfirm) GetEvmAddress() string {
	if m != nil {
		return m.EvmAddress
	}
	return ""
...
type MsgDataCommitmentConfirm struct {
	...
	// Hex `0x` encoded EVM public key that will be used by this validator on
	// EVM.
...
func (m *MsgDataCommitmentConfirm) GetOrchestrator() string {
	if m != nil {
		return m.Orchestrator
	}
	return ""
...
func (m *MsgDataCommitmentConfirm) GetEvmAddress() string {
	if m != nil {
		return m.EvmAddress
	}
	return ""
...
var fileDescriptor_c696c358dc748aba = []byte{
	...
	,
}
