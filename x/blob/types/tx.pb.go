...
// source: celestia/blob/v2/tx.proto
...
func (*MsgPayForBlobs) Descriptor() ([]byte, []int) {
	return fileDescriptor_82f557c0bb46a753, []int{0}
}
...
func (*MsgPayForBlobsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_82f557c0bb46a753, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgPayForBlobs)(nil), "celestia.blob.v2.MsgPayForBlobs")
	proto.RegisterType((*MsgPayForBlobsResponse)(nil), "celestia.blob.v2.MsgPayForBlobsResponse")
}

func init() { proto.RegisterFile("celestia/blob/v2/tx.proto", fileDescriptor_82f557c0bb46a753) }

var fileDescriptor_82f557c0bb46a753 = []byte{
	...
	0x84, 0xa0, 0x98, 0xd1, 0xba, 0x73, 0x59, 0xc1, 0x85, 0x50, 0x90, 0x08, 0x2e, 0xdc, 0x94, 0x49,
	...
	0xa0, 0x84, 0x14, 0x45, 0xe7, 0x8e, 0x50, 0xad, 0x87, 0xa1, 0x3e, 0xa1, 0x7f, 0xd6, 0xff, 0xcd,
	0x72, 0xbf, 0xbf, 0x8f, 0xbb, 0x19, 0xd0, 0x76, 0x7e, 0x72, 0xac, 0x2a, 0xec, 0x9d, 0xfb, 0x97,
	0xf7, 0xc7, 0x72, 0xcb, 0xfe, 0xbf, 0xbc, 0xc2, 0x11, 0x93, 0x7c, 0x7c, 0x03, 0x59, 0x3e, 0xe1,
	0x09, 0xd9, 0xeb, 0x9e, 0x3f, 0xcf, 0x4c, 0x32, 0x9d, 0x99, 0xe4, 0x6d, 0x66, 0x92, 0x87, 0xb9,
	0x59, 0x9a, 0xce, 0xcd, 0xd2, 0xeb, 0xdc, 0x2c, 0x5d, 0x1f, 0x86, 0x91, 0x1a, 0xdc, 0xfa, 0x6e,
	0x00, 0x09, 0x5b, 0xd5, 0x41, 0x16, 0x7e, 0x7e, 0x1f, 0x70, 0x29, 0xd9, 0x68, 0x91, 0xab, 0xc6,
	0x52, 0xa0, 0x5f, 0x29, 0xce, 0x75, 0xfc, 0x11, 0x00, 0x00, 0xff, 0xff, 0x12, 0x01, 0x66, 0x37,
	0xfb, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) PayForBlobs(ctx context.Context, in *MsgPayForBlobs, opts ...grpc.CallOption) (*MsgPayForBlobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/celestia.blob.v2.Msg/PayForBlobs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PayForBlobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/celestia.blob.v2.Msg/PayForBlobs",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "celestia.blob.v2.Msg",
	...
	Metadata: "celestia/blob/v2/tx.proto",
}
