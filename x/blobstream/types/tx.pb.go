...
func (*MsgRegisterEVMAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_d02473b648247317, []int{0}
}
...
func (*MsgRegisterEVMAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d02473b648247317, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgRegisterEVMAddress)(nil), "celestia.qgb.v2.MsgRegisterEVMAddress")
	proto.RegisterType((*MsgRegisterEVMAddressResponse)(nil), "celestia.qgb.v2.MsgRegisterEVMAddressResponse")
}

func init() { proto.RegisterFile("celestia/qgb/v2/tx.proto", fileDescriptor_d02473b648247317) }

var fileDescriptor_d02473b648247317 = []byte{
	...
	0xb0, 0x82, 0x77, 0x0b, 0x3d, 0x16, 0x64, 0x05, 0x0f, 0x5e, 0x4a, 0xb6, 0x0d, 0x31, 0xb0, 0xbb,
	...
	,
}
...
func (c *msgClient) RegisterEVMAddress(ctx context.Context, in *MsgRegisterEVMAddress, opts ...grpc.CallOption) (*MsgRegisterEVMAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/celestia.qgb.v2.Msg/RegisterEVMAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterEVMAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/celestia.qgb.v2.Msg/RegisterEVMAddress",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "celestia.qgb.v2.Msg",
	...
	Metadata: "celestia/qgb/v2/tx.proto",
}
