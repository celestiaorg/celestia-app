...
type MsgCreateZKExecutionISM struct {
	...
	CelestiaStateRoot []byte `protobuf:"bytes,4,opt,name=celestia_state_root,json=celestiaStateRoot,proto3" json:"celestia_state_root,omitempty"`
...
func (m *MsgCreateZKExecutionISM) GetCelestiaStateRoot() []byte {
	if m != nil {
		return m.CelestiaStateRoot
	}
	return nil
}
...
type MsgUpdateZKExecutionISMResponse struct {
	...
	Height uint64 `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`
	// trusted celestia root
	CelestiaStateRoot string `protobuf:"bytes,3,opt,name=celestia_state_root,json=celestiaStateRoot,proto3" json:"celestia_state_root,omitempty"`
	// trusted celestia height
...
func (m *MsgUpdateZKExecutionISMResponse) GetCelestiaStateRoot() string {
	if m != nil {
		return m.CelestiaStateRoot
	}
	return ""
...
var fileDescriptor_9627100907186bb5 = []byte{
	...
	,
}
...
func (m *MsgCreateZKExecutionISM) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CelestiaStateRoot) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.CelestiaStateRoot)))
		i--
		dAtA[i] = 0x22
	}
	if m.Height != 0 {
...
func (m *MsgCreateZKExecutionISM) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.CelestiaStateRoot = append(m.CelestiaStateRoot[:0], dAtA[iNdEx:postIndex]...)
			if m.CelestiaStateRoot == nil {
				m.CelestiaStateRoot = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
