...
type EvExecutionPublicValues struct {
	...
	PreviousCelestiaHeight uint64
	// PreviousCelestiaHeaderHash is the hash of the celestia header at which previous_height is available.
	PreviousCelestiaHeaderHash [32]byte
