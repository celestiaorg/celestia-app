...
var (
	pattern_Msg_PayForMessage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"layzyledger", "lazyledgerapp", "payformessage"}, "", runtime.AssumeColonVerbOpt(true)))
)
