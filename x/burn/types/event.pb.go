...
// source: celestia/burn/v1/event.proto
...
// EventBurn is emitted when tokens are permanently burned by the EndBlocker.
type EventBurn struct {
	// burner is the address from which tokens were burned (the burn address)
	Burner string `protobuf:"bytes,1,opt,name=burner,proto3" json:"burner,omitempty"`
	// amount is the amount of tokens burned (e.g., "1000000utia")
...
func (*EventBurn) Descriptor() ([]byte, []int) {
	return fileDescriptor_923ce09d86df70aa, []int{0}
}
...
func init() {
	proto.RegisterType((*EventBurn)(nil), "celestia.burn.v1.EventBurn")
}

func init() { proto.RegisterFile("celestia/burn/v1/event.proto", fileDescriptor_923ce09d86df70aa) }

var fileDescriptor_923ce09d86df70aa = []byte{
	// 211 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x4e, 0xcd, 0x49,
	0x2d, 0x2e, 0xc9, 0x4c, 0xd4, 0x4f, 0x2a, 0x2d, 0xca, 0xd3, 0x2f, 0x33, 0xd4, 0x4f, 0x2d, 0x4b,
	...
	,
}
