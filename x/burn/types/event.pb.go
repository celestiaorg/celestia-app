...
// EventBurn is emitted when tokens are permanently burned.
type EventBurn struct {
	// signer is the address that burned the tokens
...
func (m *EventBurn) GetSigner() string {
	if m != nil {
		return m.Signer
	}
	return ""
...
var fileDescriptor_923ce09d86df70aa = []byte{
	...
	0xca, 0x0c, 0x95, 0xac, 0xb9, 0x38, 0x5d, 0x41, 0x0a, 0x9c, 0x4a, 0x8b, 0xf2, 0x84, 0xc4, 0xb8,
	0xd8, 0x8a, 0x33, 0xd3, 0xf3, 0x52, 0x8b, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xa0, 0x3c,
	0x90, 0x78, 0x62, 0x6e, 0x7e, 0x69, 0x5e, 0x89, 0x04, 0x13, 0x44, 0x1c, 0xc2, 0x73, 0xf2, 0x3a,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x98, 0x9d, 0xf9, 0x45, 0xe9, 0x70, 0xb6, 0x6e, 0x62, 0x41,
	0x81, 0x7e, 0x05, 0xc4, 0x8d, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x17, 0x1a, 0x03,
	0x02, 0x00, 0x00, 0xff, 0xff, 0xd3, 0x40, 0xf6, 0xd7, 0xc1, 0x00, 0x00, 0x00,
}
