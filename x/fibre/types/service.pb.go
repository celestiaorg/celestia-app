...
// Contains row data along with RLC proof data:
// - coefficients: flattened RLC coefficients (K × 16 bytes), stored during upload
// - root: RLC Merkle root (32 bytes), computed during upload verification
...
type DownloadShardRequest struct {
	...
	WithRlc bool   `protobuf:"varint,2,opt,name=with_rlc,json=withRlc,proto3" json:"with_rlc,omitempty"`
}
...
func (m *DownloadShardRequest) GetWithRlc() bool {
	if m != nil {
		return m.WithRlc
	}
	return false
...
var fileDescriptor_15ef7a812f3b6799 = []byte{
	...
	,
}
...
func (m *DownloadShardRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithRlc", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
