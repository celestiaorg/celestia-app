...
// source: celestia/signal/v2/query.proto
...
func (*QueryVersionTallyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac017e15f9a5094a, []int{0}
}
...
func (*QueryVersionTallyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac017e15f9a5094a, []int{1}
}
...
func (*QueryGetUpgradeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac017e15f9a5094a, []int{2}
}
...
func (*QueryGetUpgradeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac017e15f9a5094a, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryVersionTallyRequest)(nil), "celestia.signal.v2.QueryVersionTallyRequest")
	proto.RegisterType((*QueryVersionTallyResponse)(nil), "celestia.signal.v2.QueryVersionTallyResponse")
	proto.RegisterType((*QueryGetUpgradeRequest)(nil), "celestia.signal.v2.QueryGetUpgradeRequest")
	proto.RegisterType((*QueryGetUpgradeResponse)(nil), "celestia.signal.v2.QueryGetUpgradeResponse")
}

func init() { proto.RegisterFile("celestia/signal/v2/query.proto", fileDescriptor_ac017e15f9a5094a) }

var fileDescriptor_ac017e15f9a5094a = []byte{
	...
	,
}
...
func (c *queryClient) VersionTally(ctx context.Context, in *QueryVersionTallyRequest, opts ...grpc.CallOption) (*QueryVersionTallyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/celestia.signal.v2.Query/VersionTally", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetUpgrade(ctx context.Context, in *QueryGetUpgradeRequest, opts ...grpc.CallOption) (*QueryGetUpgradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/celestia.signal.v2.Query/GetUpgrade", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_VersionTally_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/celestia.signal.v2.Query/VersionTally",
	}
...
func _Query_GetUpgrade_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/celestia.signal.v2.Query/GetUpgrade",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "celestia.signal.v2.Query",
	...
	Metadata: "celestia/signal/v2/query.proto",
}
