...
// Matching the binding forwards and dispatches through the committed hook. Metadata-only is
// intentionally valid because the mailbox default hook may consume custom metadata; it dispatches
// with a nil hook override. hook+metadata is covered by
