...
func TestOverrideConsensusConfig_Integration(t *testing.T) {
	...
	assert.Equal(t, appconsts.DefaultTimeoutPropose, modifiedCfg.Consensus.TimeoutPropose)
	assert.Equal(t, appconsts.DefaultTimeoutPrevote, modifiedCfg.Consensus.TimeoutPrevote)
	assert.Equal(t, appconsts.DefaultTimeoutPrevoteDelta, modifiedCfg.Consensus.TimeoutPrevoteDelta)
	assert.Equal(t, appconsts.DefaultTimeoutPrecommit, modifiedCfg.Consensus.TimeoutPrecommit)
	assert.Equal(t, appconsts.DefaultTimeoutPrecommitDelta, modifiedCfg.Consensus.TimeoutPrecommitDelta)
	assert.Equal(t, appconsts.DefaultTimeoutCommit, modifiedCfg.Consensus.TimeoutCommit)
}
