...
func newStartCmd(start func(context.Context, fibre.ServerConfig) error) *cobra.Command {
	...
	cmd.Flags().BoolVar(&cfg.OverrideObjectNamespace, flagOverrideObjectNamespace, false, "accept an object namespace change after migrating retained objects; does not migrate or verify objects")
