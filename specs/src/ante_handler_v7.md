...
App version 7 introduces the [feeaddress](https://github.com/celestiaorg/celestia-app/blob/main/x/feeaddress/README.md) module which enables a mechanism to forward tokens to validators as staking rewards. The ante handler includes two decorators to support this:
