...
func MajorUpgradeToV3(logger *log.Logger) error {
	...
	for i := 0; i < numNodes; i++ {
		err := testNet.CreateGenesisNode(ctx, nil, latestVersion, 10000000, 0, testnet.DefaultResources, true)
	...
	err = testNet.CreateTxClient(ctx, nil, "txsim", latestVersion, 1, "100-2000", 100, testnet.DefaultResources, endpoints[0], upgradeSchedule)
