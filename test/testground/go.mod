...
require (
	github.com/celestiaorg/celestia-app v1.0.0-rc0.0.20231123173443-abf0bf24f120
...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.29.0-tm-v0.34.29.0.20231123174056-1262cad77f67 //v1.29.0-tm-v0.34.29
)
