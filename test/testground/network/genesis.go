...
func GenesisDoc(
	...
	genBals, genAccs, err := genAccountsToSDKTypes(addrs, pubkeys)
	if err != nil {
		return nil, err
	}
...
func genAccountsToSDKTypes(addrs []string, pubkeys []cryptotypes.PubKey) ([]banktypes.Balance, []authtypes.GenesisAccount, error) {
