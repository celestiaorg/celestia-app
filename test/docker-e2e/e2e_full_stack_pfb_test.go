...
import (
	...
	v7 "github.com/celestiaorg/celestia-app/v9/pkg/appconsts/v7"
...
// removeDANetwork removes all nodes in the Data Availability Network, including bridge and light nodes.
