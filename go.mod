...
require (
	...
	github.com/umee-network/umee v0.4.0-rc3 // indirect
...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v0.34.14-celestia.0.20220204195923-742fb3a6ab8d
