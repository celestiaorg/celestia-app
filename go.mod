...
require (
	...
	github.com/celestiaorg/knuu v0.14.1-0.20240705051853-d53564a24de9
...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.36.1-tm-v0.34.29.0.20240627235159-baab84ccd829
)
