...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.26.0-tm-v0.34.28.0.20230809151601-e5e0291eb76f // v1.26.0-tm-v0.34.28.0.20230808095911-2f93fc823f17 // v1.24.0-tm-v0.34.28
)
