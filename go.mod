...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.24.0-tm-v0.34.28.0.20230714090943-ebfec98ff3e1 //v1.24.0-tm-v0.34.28.0.20230712002207-6c02e76f5831 // v1.24.0-tm-v0.34.28
)
