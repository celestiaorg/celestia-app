...
replace (
	...
	github.com/tendermint/tendermint v0.34.20 => github.com/celestiaorg/celestia-core v1.9.0-tm-v0.34.20.0.f7cb538bd916b430ffa9dc7fbc95d9a5f1f1801d // v1.8.0-tm-v0.34.20
)
