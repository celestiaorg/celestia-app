...
replace (
	...
	github.com/cometbft/cometbft => github.com/celestiaorg/celestia-core v1.58.0-tm-v0.38.17
	github.com/cosmos/cosmos-sdk => github.com/celestiaorg/cosmos-sdk v1.30.0-sdk-v0.50.14
