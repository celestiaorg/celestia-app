...
func TestMinDataAvailabilityHeader(t *testing.T) {
	...
	expectedHash := []byte{
		0x46, 0xc5, 0x46, 0x74, 0xe9, 0xfa, 0x91, 0x48, 0xfd, 0x9f, 0x8c, 0xdb, 0x16, 0xa2, 0xc, 0x0,
		0x60, 0x4b, 0xf0, 0x7a, 0xaa, 0x51, 0x65, 0xe3, 0x65, 0x75, 0x41, 0xa1, 0x60, 0xc9, 0xeb, 0x9d,
	}
	...
	tests := []test{
		{
			name: "typical",
			expectedHash: []byte{
				0xc5, 0xca, 0x2e, 0xbf, 0x5a, 0x9b, 0x60, 0xc2, 0xda, 0xb, 0x9, 0x87, 0x84, 0x1b, 0x47, 0x75,
				0x44, 0x84, 0x93, 0xc6, 0x31, 0x56, 0x73, 0x9a, 0xcb, 0xe7, 0x3f, 0x1a, 0x0, 0x4f, 0x40, 0x3e,
			},
			squareSize: 2,
		...
		},
		{
			...
			expectedHash: []byte{
				0x99, 0xdd, 0x89, 0x49, 0xa3, 0x5b, 0x91, 0xc, 0xef, 0xd4, 0x78, 0xa, 0xaf, 0x71, 0x25, 0x8b,
				0x1e, 0x51, 0x83, 0xde, 0x8a, 0x9a, 0x54, 0x72, 0x4, 0xa9, 0xae, 0x59, 0x3a, 0xb1, 0x90, 0xdc,
			},
