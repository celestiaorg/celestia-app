...
import (
	...
	"github.com/celestiaorg/celestia-app/v7/pkg/appconsts/v5"
	"github.com/celestiaorg/celestia-app/v7/pkg/wrapper"
	daproto "github.com/celestiaorg/celestia-app/v7/proto/celestia/core/v1/da"
...
func ConstructEDS(txs [][]byte, appVersion uint64, maxSquareSize int) (*rsmt2d.ExtendedDataSquare, error) {
	...
	case 6: // version 6 is compatible with v3 of the square package
		if maxSquareSize < 0 {
	...
	default: // assume all other versions are compatible with v4 of the square package
		...
		square, err := squarev4.Construct(txs, maxSquareSize, appconsts.SubtreeRootThreshold, squarev4.NoOpPayForFibreHandler())
		if err != nil {
			return nil, err
		}
