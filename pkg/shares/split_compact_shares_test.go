...
func TestCount(t *testing.T) {
	...
	testCases := []testCase{
		...
		{transactions: []coretypes.Tx{bytes.Repeat([]byte{0}, appconsts.CompactContinuationShareContentSize+1)}, wantShareCount: 2},
		{transactions: []coretypes.Tx{bytes.Repeat([]byte{0}, appconsts.CompactContinuationShareContentSize*2+1)}, wantShareCount: 3},
	}
