...
func (ss *shareStack) resolve() ([][]byte, error) {
	...
	err = ss.peel(ss.shares[0][appconsts.NamespaceSize+appconsts.ShareInfoBytes+appconsts.CompactShareDataLengthBytes+appconsts.CompactShareReservedBytes:], true)
	return ss.data, err
}
