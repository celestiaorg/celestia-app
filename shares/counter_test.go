...
func TestCounterMatchesCompactShareSplitter(t *testing.T) {
	testCases := []struct {
		...
		{txs: []coretypes.Tx{newTx(shares.FirstCompactShareContentSize - 2)}},
		{txs: []coretypes.Tx{newTx(shares.FirstCompactShareContentSize - 1)}},
		{txs: []coretypes.Tx{newTx(shares.FirstCompactShareContentSize)}},
		{txs: []coretypes.Tx{newTx(shares.FirstCompactShareContentSize + 1)}},
		{txs: []coretypes.Tx{newTx(shares.FirstCompactShareContentSize), newTx(shares.ContinuationCompactShareContentSize - 4)}},
		{txs: newTxs(1000, 100)},
		{txs: newTxs(100, 1000)},
		{txs: newTxs(8931, 77)},
	}
