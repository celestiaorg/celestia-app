...
func TestShareBuilderAddData(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			builder: mustNewBuilder(t, TxNamespace, ShareVersionZero, true),
			data:    bytes.Repeat([]byte{1}, ShareSize-NamespaceSize-ShareInfoBytes-CompactShareReservedBytes-SequenceLenBytes),
			want:    nil,
		},
		{
		...
		},
		{
			...
			builder: mustNewBuilder(t, TxNamespace, ShareVersionZero, false),
			data:    bytes.Repeat([]byte{1}, ShareSize-NamespaceSize-CompactShareReservedBytes-1 /*1 = info byte*/),
			want:    nil,
		},
		{
		...
		},
		{
			...
			builder: mustNewBuilder(t, TxNamespace, ShareVersionZero, true),
			data:    bytes.Repeat([]byte{1}, 1 /*1 extra byte*/ +ShareSize-NamespaceSize-CompactShareReservedBytes-SequenceLenBytes-1 /*1 = info byte*/),
			want:    []byte{1},
		},
		{
		...
		},
		{
			...
			builder: mustNewBuilder(t, TxNamespace, ShareVersionZero, false),
			data:    bytes.Repeat([]byte{1}, 1 /*1 extra byte*/ +ShareSize-NamespaceSize-CompactShareReservedBytes-1 /*1 = info byte*/),
			want:    []byte{1},
		},
		{
