...
test-interchain:
	@echo "Reminder: this test uses the latest celestia-app Docker image.
	@echo "If you would like to test recent code changes, re-build the Docker image by running: make build-docker"
