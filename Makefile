...
# https://github.com/celestiaorg/celestia-app/issues/1369
	...
	@go test -timeout 15m ./... -v -race -skip "TestPrepareProposalConsistency|TestIntegrationTestSuite|TestTxsimCommandFlags|TestEvictions|TestPrepareProposalCappingNumberOfMessages|TestGasEstimatorE2E|TestSquareSizeIntegrationTest|TestClientServerUploadDownload"
.PHONY: test-race
